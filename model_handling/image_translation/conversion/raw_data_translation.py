...
IMAGE_OUT_PATH = "../model_handling/training/darknet/data/images/"
TRAINING_DATA_PATH = "../model_handling/training/darknet/data/"
DATA_NAMES_PATH = TRAINING_DATA_PATH + "/obj.names"
...
def translate():
    ...
    if not os.path.isfile(DATA_NAMES_PATH):
        data_file = open(DATA_NAMES_PATH, "w+")
        data_file.write("CENTER")
        data_file.close()
